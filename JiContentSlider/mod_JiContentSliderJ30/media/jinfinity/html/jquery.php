...
if(version_compare(JVERSION, '3.0.0', 'l')) {
    ...
    abstract class JHtmlJquery
    {
        ...
        public static function framework($noConflict = true, $debug = null)
        {
            ...
            JHTML::_('script', 'jquery.min.js', 'media/jinfinity/js/');

            // Check if we are loading in noConflict
            if ($noConflict)
            {
                JHTML::_('script', 'jquery.noconflict.js', 'media/jinfinity/js/');
            }
        ...
        public static function ui(array $components = array('core'), $debug = null)
        {
            ...
            foreach ($components as $component)
            {
                ...
                if (in_array($component, $supported) && empty(self::$loaded[__METHOD__][$component]))
                {
                    ...
                    JHTML::_('script', 'jquery.ui.' . $component . '.min.js', 'media/jinfinity/js/');
