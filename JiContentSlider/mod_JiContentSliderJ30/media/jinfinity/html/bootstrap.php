...
if(version_compare(JVERSION, '3.0.0', 'l')) {
    ...
    abstract class JHtmlBootstrap
    {
        ...
        public static function framework($debug = null)
        {
            ...
            JHTML::_('script', 'bootstrap.min.js', 'media/jinfinity/js/');
        ...
        public static function loadCss($includeMainCss = true, $direction = 'ltr', $attribs = array())
        {
            ...
            if ($includeMainCss)
            {
                JHtml::_('stylesheet', 'bootstrap.min.css', 'media/jinfinity/css/', $attribs, false);
                JHtml::_('stylesheet', 'bootstrap-responsive.min.css', 'media/jinfinity/css/', $attribs, false);
                JHtml::_('stylesheet', 'bootstrap-extended.css', 'media/jinfinity/css/', $attribs, false);
            ...
            if ($direction === 'rtl')
            {
                JHtml::_('stylesheet', 'bootstrap-rtl.css', 'media/jinfinity/css/', $attribs, false);
            }
        }
        /**
