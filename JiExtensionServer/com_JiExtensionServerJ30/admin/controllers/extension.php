<?php
/**
 * @version     $Id: extension.php 015 2013-06-17 11:16:00Z Anton Wintergerst $
...
class JiExtensionServerControllerExtension extends JControllerForm
{
    ...
    public function batch($model = null)
    {
        ...
        // Preset the redirect
        $this->setRedirect(JRoute::_('index.php?option=com_jiextensionserver&view=extensions' . $this->getRedirectToListAppend(), false));
