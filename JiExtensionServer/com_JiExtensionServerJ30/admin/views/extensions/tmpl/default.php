<?php
/**
 * @version     $Id: default.php 058 020 2014-12-30 12:48:00Z Anton Wintergerst $
...
<div class="jinfinity jiextensionserver<?php if(version_compare(JVERSION, '3.0.0', 'l')) echo ' row-fluid'; ?>">
    <div class="extensions<?php if(version_compare(JVERSION, '3.0.0', 'l')) echo ' span12'; ?>">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_jiextensionserver&view=extensions');?>" method="post" name="adminForm" id="adminForm">
                ...
                <table class="table table-striped" id="articleList">
                    ...
                    <tr>
                        ...
                        <th width="1%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_PREMIUM_LABEL', 'e.premium', $listDirn, $listOrder); ?>
                        </th>
                        <th width="1%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_DOWNLOADHITS_LABEL', 'downloadhits', $listDirn, $listOrder); ?>
                        </th>
                        <th width="10%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_PUBLISHUP_LABEL', 'e.publish_up', $listDirn, $listOrder); ?>
                        </th>
                        <th width="10%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_PUBLISHDOWN_LABEL', 'e.publish_down', $listDirn, $listOrder); ?>
                        </th>
                        <th width="1%" class="nowrap hidden-phone">
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
                            ...
                            <td class="nowrap has-context">
                                <div class="pull-left">
                                    <a href="<?php echo JRoute::_('index.php?option=com_jiextensionserver&task=extension.edit&id=' . $item->id);?>" title="<?php echo JText::_('JACTION_EDIT');?>"><?php echo $this->escape($item->title); ?></a>
                                </div>
                                <div class="pull-left">
                                    <?php
                                    if(version_compare(JVERSION, '3.0.0', 'ge')) {
