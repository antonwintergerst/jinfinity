...
class JiExtensionServerViewExtensions extends JViewLegacy
{
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_JIEXTENSIONSERVER_EXTENSIONS'), 'jiextensionserver.png');
        ...
        if(version_compare(JVERSION, '3.0.0', 'ge')) {
            JHtmlSidebar::setAction('index.php?option=com_jiextensionserver&view=extensions');
