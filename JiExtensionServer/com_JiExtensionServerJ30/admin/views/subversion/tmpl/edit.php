<?php
/**
 * @version     $Id: edit.php 020 2013-09-05 16:37:00Z Anton Wintergerst $
...
<div class="jinfinity jiextensionserver<?php if(version_compare(JVERSION, '3.0.0', 'l')) echo ' row-fluid'; ?>">
    <div class="subversion<?php if(version_compare(JVERSION, '3.0.0', 'l')) echo ' span12'; ?>">
        <script type="text/javascript">
            Joomla.submitbutton = function(task) {
                if (task == 'subversion.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
            ...
            <div class="row-fluid">
                            ...
                            <fieldset class="adminform">
                                <div class="row-fluid">
                                    <div class="span6">
                                        ...
                                        <div class="control-group">
                                            <?php echo $this->form->getLabel('bid'); ?>
                                            <div class="controls">
                                                <?php echo $this->form->getInput('bid'); ?>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <?php echo $this->form->getLabel('subversion'); ?>
                                            <div class="controls">
                                                <?php echo $this->form->getInput('subversion'); ?>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <?php echo $this->form->getLabel('downloadurl'); ?>
                                            <div class="controls">
                                                <?php echo $this->form->getInput('downloadurl'); ?>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                    ...
                                    <div class="span6">
                                        <div class="control-group">
                                            <?php echo $this->form->getLabel('premium'); ?>
                                            <div class="controls">
                                                <?php echo $this->form->getInput('premium'); ?>
                                            </div>
                                        </div>
                                        <div class="control-group">
                ...
                <div class="span2">
                    ...
                    <fieldset class="form-vertical">
                        ...
                        <div class="control-group">
                            <?php echo $this->form->getLabel('downloadhits'); ?>
                            <div class="controls">
                                <?php echo $this->form->getInput('downloadhits'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <?php echo $this->form->getLabel('updatehits'); ?>
                            <div class="controls">
                                <?php echo $this->form->getInput('updatehits'); ?>
                            </div>
                        </div>
                        <div class="control-group">
