...
<form action="<?php echo JRoute::_('index.php?option=com_jiextensionserver&view=users');?>" method="post" name="adminForm" id="adminForm">
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th width="10%" class="nowrap center">
                        <?php echo JText::_('COM_JIEXTENSIONSERVER_DOWNLOADTOKEN_LABEL'); ?>
                    </th>
                        ...
                        <td class="center dltoken">
                            <div>
                                    ...
                                    if(typeof jQuery!='undefined') {
                                        jQuery(document).ready(function() {
                                            if(typeof ZeroClipboard!='undefined') {
                                                ...
                                                clip.setText(jQuery('.dltoken<?php echo $item->id; ?>').val());
                                                clip.addEventListener('onComplete', function() {
                                                    jQuery('.copydltoken<?php echo $item->id; ?>').removeClass('btn-primary');
                                                    jQuery('.copydltoken<?php echo $item->id; ?>').html('Copied!');
                                                });
                                                clip.glue(jQuery('.copydltoken<?php echo $item->id; ?>').get(0));
                                                console.log(jQuery('.copydltoken<?php echo $item->id; ?>').get(0));
                                            } else {
                                                var clip = new ZeroClipboard(jQuery('.copydltoken<?php echo $item->id; ?>').get(0), {
                                ...
                                <div class="input-prepend input-append">
                                    ...
                                    <input class="dltoken<?php echo $item->id; ?>" type="text" value="<?php echo $model->getToken($item->id); ?>">
                                    <a class="btn btn-primary copydltoken<?php echo $item->id; ?>" href="#">Copy</a>
                                </div>
                            </div>
                        </td>
                        <td class="center">
