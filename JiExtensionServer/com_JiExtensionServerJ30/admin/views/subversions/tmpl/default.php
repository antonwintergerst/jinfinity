...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_jiextensionserver&task=subversions.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'subversionList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<div class="jinfinity jiextensionserver<?php if(version_compare(JVERSION, '3.0.0', 'l')) echo ' row-fluid'; ?>">
    <div class="subversions<?php if(version_compare(JVERSION, '3.0.0', 'l')) echo ' span12'; ?>">
        ...
        <form action="<?php echo JRoute::_('index.php?option=com_jiextensionserver&view=subversions');?>" method="post" name="adminForm" id="adminForm">
                ...
                <table class="table table-striped" id="articleList">
                    ...
                    <tr>
                        ...
                        <th width="1%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_PREMIUM_LABEL', 's.premium', $listDirn, $listOrder); ?>
                        </th>
                        <th width="1%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_DOWNLOADHITS_LABEL', 's.downloadhits', $listDirn, $listOrder); ?>
                        </th>
                        <th width="1%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_UPDATEHITS_LABEL', 's.updatehits', $listDirn, $listOrder); ?>
                        </th>
                        <th width="10%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_PUBLISHUP_LABEL', 's.publish_up', $listDirn, $listOrder); ?>
                        </th>
                        <th width="10%" class="nowrap hidden-phone">
                            <?php echo JHtml::_('grid.sort', 'COM_JIEXTENSIONSERVER_PUBLISHDOWN_LABEL', 's.publish_down', $listDirn, $listOrder); ?>
                        </th>
                        <th width="1%" class="nowrap hidden-phone">
                    ...
                    foreach ($this->items as $i => $item) :
                        ...
                        <?php if($currentextension!=$item->eid): ?>
                            <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        <?php echo JHtml::_('jgrid.published', $item->state, $i, 'extensions.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                                    </div>
                                </td>
                        ...
                        <?php if($currentbranch!=$item->bid): ?>
                            <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
                                ...
                                <td class="center hidden-phone">
                                    <?php echo JHtml::_('grid.id', $i, $item->bid); ?>
                                </td>
                                <td class="center">
                                    <div class="btn-group">
                                ...
                                <td class="nowrap has-context">
                                    <div class="pull-left">
                                        <span class="gi">|—</span>
                                        <a href="<?php echo JRoute::_('index.php?option=com_jiextensionserver&task=branch.edit&id=' . $item->bid);?>" title="<?php echo JText::_('JACTION_EDIT');?>">
                                    ...
                                    <div class="pull-left">
                                        ...
                                        if(version_compare(JVERSION, '3.0.0', 'ge')) {
                                            // Create dropdown items
                                            JHtml::_('dropdown.edit', $item->bid, 'article.');
                                            JHtml::_('dropdown.divider');
                                            if ($item->state) :
                                                JHtml::_('dropdown.unpublish', 'cb' . $i, 'extensions.');
                                            else :
                                ...
                                <td class="center hidden-phone">
                                    <?php echo (int) $item->bid; ?>
                                </td>
                            </tr>
                            <?php $currentbranch = $item->bid; ?>
                        <?php endif; ?>
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
                            <td class="order nowrap center hidden-phone">
                                <?php if ($canChange) :
                            ...
                            <td class="center">
                                <div class="btn-group">
                                    <?php echo JHtml::_('jgrid.published', $item->state, $i, 'subversions.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                                </div>
                            </td>
                            <td class="nowrap has-context">
                                <div class="pull-left">
                                    <span class="gi">|—</span>
                                    <span class="gi">|—</span>
                                    <a href="<?php echo JRoute::_('index.php?option=com_jiextensionserver&task=subversion.edit&id=' . $item->id);?>" title="<?php echo JText::_('JACTION_EDIT');?>"><?php echo $this->escape($item->subversion); ?></a>
                                </div>
                                <div class="pull-left">
                                    <?php
                                    if(version_compare(JVERSION, '3.0.0', 'ge')) {
                                        ...
                                        JHtml::_('dropdown.divider');
                                        if ($item->state) :
                                            JHtml::_('dropdown.unpublish', 'cb' . $i, 'subversions.');
                                        else :
                                            JHtml::_('dropdown.publish', 'cb' . $i, 'subversions.');
                                        endif;

                                        JHtml::_('dropdown.divider');

                                        if ($archived) :
                                            JHtml::_('dropdown.unarchive', 'cb' . $i, 'subversions.');
                                        else :
                                            JHtml::_('dropdown.archive', 'cb' . $i, 'subversions.');
                                        endif;

                                        if ($trashed) :
                                            JHtml::_('dropdown.untrash', 'cb' . $i, 'subversions.');
                                        else :
                                            JHtml::_('dropdown.trash', 'cb' . $i, 'subversions.');
                                        endif;
                            ...
                            <td class="small hidden-phone">
                                <?php echo ($item->premium==1)? JText::_('COM_JIEXTENSIONSERVER_YES') : JText::_('COM_JIEXTENSIONSERVER_NO'); ?>
                            </td>
                            <td class="small hidden-phone">
                                <?php echo $item->downloadhits; ?>
                            </td>
