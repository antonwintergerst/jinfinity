<style>
    .pong {padding: 0; margin: 0; overflow: hidden; width: 100%;}
    .over {font-size: 100px;}
</style>
<div class="pong">
...
function btnClick(e) {
    ...
    if(mx >= startBtn.x && mx <= startBtn.x + startBtn.w) {
        ...
        setTimeout(function(){
            jQuery('.pong').replaceWith('<h2 class="over">GET BACK TO WORK!</h2>');
        }, 30000);
    }
