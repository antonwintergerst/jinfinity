<?php
/**
 * @version     $Id: router.php 010 2013-06-13 11:00:00Z Anton Wintergerst $
 ...
 * @since   1.5
 */
function JiExtensionServerBuildRoute(&$query)
{
    $segments   = array();
    ...
    // #Jinfinity
    if ($view == 'category' || $view == 'article' || $view == 'search')
    {
        if (!$menuItemGiven) {
            $segments[] = $view;
        }
 ...
 * @since   1.5
 */
function JiExtensionServerParseRoute($segments)
{
    $vars = array();
