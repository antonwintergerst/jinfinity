...
/**
 * @version     $Id: default_item.php 016 2014-11-04 10:23:00Z Anton Wintergerst $
...
<?php // #Jinfinity
// find and remove the images in the text $this->item->introtext
$JiLayoutTools->getImages($this->item, 'introtext'); ?>
<?php if(count($this->item->jiimages)>0): ?>
    <?php // only show the first image
    $image = $this->item->jiimages[0];
    // create a thumbnail
    $image->path = $JiLayoutTools->createThumbnail($image->path, array('context'=>'featured', 'resize'=>1, 'width'=>160, 'height'=>160, 'cache'=>1));
    ?>
    <div class="category-image">
        <?php if(isset($image->linkattribs)):
        ...
        <?php else:
            ...
            <a class="imagelink" href="<?php echo $link; ?>" title="<?php echo $this->item->title; ?>">
                <img src="<?php echo $image->path; ?>"<?php echo $JiLayoutTools->getHTMLAttribs($image->imageattribs, array('class')); ?>/>
            </a>
        <?php endif; ?>
    </div>
...
echo $introtext = $JiLayoutTools->truncateChars($this->item->introtext, 150, '...', true, 1); ?>
...
<?php if ($params->get('show_readmore') && $this->item->readmore || ($introtext!=$this->item->introtext)) : // #Jinfinity
