<?php
/**
 * @version     $Id: layouttools.php 011 2014-11-04 11:05:00Z Anton Wintergerst $
...
class JiGridLayoutTools {
    public function truncate($text, $length, $mode='chars', $suffix = '...', $isHTML = true, $insert=0, $force=0, $break='/(<\/p>)|i\s/') {
        if($mode=='words') {
    ...
    public function createThumbnail($filepath, $params) {
        ...
        if($imageset) {
            return $thumbspath.'/'.$name.'_'.$pcontext.'.jpg';
        } else {
