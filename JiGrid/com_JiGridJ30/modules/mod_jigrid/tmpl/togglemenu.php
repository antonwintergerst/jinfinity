<?php
/**
 * @version     $Id: togglemenu.php 038 2013-09-30 13:01:00Z Anton Wintergerst $
...
if(version_compare(JVERSION, '3.0.0', 'ge')) {
    JHTML::stylesheet('modules/mod_jigrid/assets/css/jitogglemenu.css');
    JHTML::script('modules/mod_jigrid/assets/js/jquery.jitogglemenu.js');
} else {
    JHTML::_('stylesheet', 'jitogglemenu.css', 'modules/mod_jigrid/assets/css/');
    JHTML::_('script', 'jquery.jitogglemenu.js', 'modules/mod_jigrid/assets/js/');
}
?>
