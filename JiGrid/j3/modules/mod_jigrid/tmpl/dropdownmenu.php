<?php
/**
 * @version     $Id: dropdownmenu.php 011 2014-12-19 13:59:00Z Anton Wintergerst $
...
if(version_compare(JVERSION, '3.0.0', 'ge')) {
    JHTML::stylesheet('media/mod_jigrid/css/jidropdownmenu.css');
    JHTML::script('media/mod_jigrid/js/jquery.jidropdownmenu.js');
} else {
    JHTML::_('stylesheet', 'jidropdownmenu.css', 'media/mod_jigrid/css/');
    JHTML::_('script', 'jquery.jidropdownmenu.js', 'media/mod_jigrid/js/');
}
?>
