...
if(strpos($browsercontext, 'notie')==false):
    if(strpos($browsercontext, 'oldie')!==false):
        // old ie ?>
        <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/assets/css/styleoldie.css" type="text/css" />
    <?php elseif(strpos($browsercontext, 'ie')!==false):
        // ie ?>
        <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/assets/css/styleie.css" type="text/css" />
    <?php endif; ?>
<?php endif; ?>
<?php
