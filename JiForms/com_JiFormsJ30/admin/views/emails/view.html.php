...
class JiFormsViewEmails extends JViewLegacy
{
    protected $items;
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('COM_JIFORMS_EMAILS'), 'jiforms.png');
        ...
        if(version_compare(JVERSION, '3.0.0', 'ge')) {
            JHtmlSidebar::setAction('index.php?option=com_jiforms&view=emails');
