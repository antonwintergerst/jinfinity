<?php
/**
 * @version     $Id: view.html.php 010 2014-03-29 11:00:00Z Anton Wintergerst $
...
class JiCustomFieldsViewField extends JViewLegacy
{
    protected $form;
    protected $item;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolbarHelper::title(JText::_('JICUSTOMFIELDS_'.($isNew ? 'ADD_FIELD' : 'EDIT_FIELD')), 'jicustomfields.png');
