...
/**
 * @version     $Id: router.php 019 2014-10-28 14:27:00Z Anton Wintergerst $
 ...
 */
// #Jinfinity
class JiCustomFieldsRouter extends JComponentRouterBase
{
    /**
    ...
    public function build(&$query)
    {
        ...
        // Check again
        if ($menuItemGiven && isset($menuItem) && ($menuItem->component != 'com_content' && $menuItem->component!='com_jicustomfields'))
        {
            $menuItemGiven = false;
            unset($query['Itemid']);
        }
        ...
        // #Jinfinity - search menu items
        if(($menuItem instanceof stdClass) && $menuItem->query['view'] == $query['view'] && $query['view']=='search') {
            unset($query['view']);
            return $segments;
        }
 ...
 */
// #Jinfinity
function JiCustomFieldsBuildRoute(&$query)
{
...
// #Jinfinity
function JiCustomFieldsParseRoute($segments)
{
    $router = new ContentRouter;
