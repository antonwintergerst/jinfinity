...
/**
 * @version     $Id: view.html.php 012 2014-11-20 11:06:00Z Anton Wintergerst $
 ...
 * @since       1.5
 */
class JiCustomFieldsViewArticle extends JViewLegacy
{
    protected $item;
    ...
    public function display($tpl = null)
    {
        ...
        JPluginHelper::importPlugin('content');
        $results = $dispatcher->trigger('onJiContentPrepare', array('com_jicustomfields.article', &$item, &$this->params, $offset));
