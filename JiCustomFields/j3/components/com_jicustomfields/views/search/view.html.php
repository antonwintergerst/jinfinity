...
/*
 * @version     $Id: view.html.php 018 2014-11-20 11:06:00Z Anton Wintergerst $
 ...
 * @since       1.5
 */
class JiCustomFieldsViewSearch extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        // stop persisting the search query
        ...
        parent::addTemplatePath(JPATH_SITE.'/components/com_content/views/featured/tmpl');
        $template = $app->getTemplate();
        // template override for com_content
        parent::addTemplatePath(JPATH_THEMES.'/'.$template.'/html/com_content/featured');
        ...
        foreach ($items as &$item)
        {
            ...
            //#Jinfinity
            JPluginHelper::importPlugin('content');
            $results = $dispatcher->trigger('onJiContentPrepare', array('com_jicustomfields.search', &$item, &$this->params, 0));
        }
