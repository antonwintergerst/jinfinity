...
/**
 * @version     $Id: edit.php 030 2014-12-19 12:31:00Z Anton Wintergerst $
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
        ...
        <fieldset>
            <ul class="nav nav-tabs">
                ...
                <?php // #Jinfinity ?>
                <li><a href="#customfields" data-toggle="tab"><?php echo JText::_('JICUSTOMFIELDS_FIELDS'); ?></a></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="customfields" class="customfields">
                    <?php // #Jinfinity
                    echo $this->form->getInput('jifields', 'attribs'); ?>
                </div>
                <?php if ($params->get('show_urls_images_frontend')): ?>
