...
/*
 * @version     $Id: view.html.php 016 2014-11-20 11:06:00Z Anton Wintergerst $
 ...
 * @since       1.5
 */
class JiCustomFieldsViewFeatured extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        foreach ($items as &$item)
        {
            ...
            //#Jinfinity
            JPluginHelper::importPlugin('content');
            $results = $dispatcher->trigger('onJiContentPrepare', array('com_jicustomfields.featured', &$item, &$this->params, 0));
        }
