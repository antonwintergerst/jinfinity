<?php
/**
 * @version     $Id: jifield.php 087 2013-10-23 10:41:00Z Anton Wintergerst $
 * @package     Jinfinity Field for Joomla 1.5+
...
class JiFieldHelper {
    ...
    function loadType($data, $type=null) {
        if($data instanceof JiField) {
            // Load field with data from JiField
    ...
    function loadField($type) {
        ...
        if(!isset($JiField)) $JiField = new JiField();
        return $JiField;
    }
    /*
    ...
    public function setPaths($paths=null) {
        if(is_array($paths)) {
            ...
            // Default paths
            $this->paths[] = JPATH_SITE.'/administrator/components/com_jicustomfields/jifields';
        }
    }
    /*
...
class JiField {
    ...
    /*
     * Sets data object that was used to create the JiField
     */
    ...
    public function setParams($data) {
        ...
        } elseif($data instanceof JiObject) {
            $this->params = $data;
    ...
    public function getParams() {
        jiimport('jiobject');
        if(!isset($this->params)) $this->params = new JiObject();
        return $this->params;
    }
