<?php
/**
 * @version     $Id: jiimageprocessorr.php 143 2013-08-26 16:49:00Z Anton Wintergerst $
 * @package     Jinfinity Image Processor for Joomla 1.5+
    ...
    public function resizeImage($oldfile, $newfile, $params, $type, $pre, $debug=0) {
        if(file_exists($oldfile)) {
            ...
            if($params->get('memcheck', 1)==1) {
                ...
                $memoryCheck = JiImageProcessor::memoryCheck($memoryNeeded, $params->get('thumbs_memincrease', false));
