...
/**
 * @version     $Id: default_item.php 020 2014-12-23 12:48:00Z Anton Wintergerst $
...
// #Jinfinity
// layout tools is already set in default.php
$JiLayoutTools = $this->item->layoutTools;
?>
...
<?php // #Jinfinity - thumbnail image
if($this->item->image): ?>
    <a class="grid-image" href="<?php echo $this->item->link; ?>" title="<?php echo $this->item->title; ?>">
        <img src="<?php echo $this->item->thumbnail->path; ?>"<?php echo $JiLayoutTools->getHTMLAttribs($this->item->image->imageattribs, array('class')); ?>/>
    </a>
<?php endif; ?>
...
echo $introtext = $JiLayoutTools->truncate($this->item->introtext, 150, '...'); ?>
