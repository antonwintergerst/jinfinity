<?php
/**
 * @version     $Id: helper.php 056 2014-12-23 10:37:00Z Anton Wintergerst $
...
class JiGridLayoutHelper extends JiGridObject {
    ...
    public function getHead() {
        ...
        JHtml::stylesheet('media/jigrid/css/jigrid.css');
        JHtml::_('jquery.framework');
        JHtml::script('media/jigrid/js/jquery.jigrid.js');
        $doc = JFactory::getDocument();
