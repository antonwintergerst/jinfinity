<?php
/**
 * @version     $Id: jiimageprocessorr.php 146 2014-01-03 09:56:00Z Anton Wintergerst $
...
class JiContentSliderImageProcessor {
    public $errormsg = '';
    public function calculateSize($width_orig, $height_orig, $pre, $params) {
    ...
    public function resizeImage($oldfile, $newfile, $params, $type, $pre, $debug=0) {
        if(file_exists($oldfile)) {
            ...
            $result = $this->calculateSize($width_orig, $height_orig, $pre, $params);
            ...
            if($params->get($pre.'_thumbs_enlarge', 1)==0) {
