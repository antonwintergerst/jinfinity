<?php
/**
 * @version     $Id: selectmenu.php 033 2014-12-19 13:59:00Z Anton Wintergerst $
...
if(version_compare(JVERSION, '3.0.0', 'ge')) {
    JHTML::stylesheet('media/mod_jigrid/css/jiselectmenu.css');
    JHTML::script('media/mod_jigrid/js/jquery.jiselectmenu.js');
} else {
    JHTML::_('stylesheet', 'jiselectmenu.css', 'media/mod_jigrid/css/');
    JHTML::_('script', 'jquery.jiselectmenu.js', 'media/mod_jigrid/js/');
}
$urls = array();
$alink = 0;
